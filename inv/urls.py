...
from .views import CategoriaView, CategoriaNew, CategoriaEdit, SubCategoriaDel
from .views import CategoriaDel, SubcategoriaView, SubCategoriaNew, SubCategoriaEdit
from .views import MarcaView, MarcaNew, MarcaEdit, marca_inactivar, UMView, UMNew, UMEdit, um_inactivar
